...
makeEmatrixPlots = function(header, 
  ...
  return(list(block_df, e_mats, all_plots))
}
makeEmatrixPlots("head_mcmc_10000_cutoff-spearman_val-0.4", levels = 5)
makeEmatrixPlots("head_mcmc_cutoff-spearman_val-0.5")
